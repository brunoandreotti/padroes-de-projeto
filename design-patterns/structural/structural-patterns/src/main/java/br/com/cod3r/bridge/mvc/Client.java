...
public class Client {
	...
	public static void main(String[] args) {
		...
		//Nesses caso, como nas classes de UserService possuem uma referência à interface UserDao, é possível criar qualquer tipo de UserService utilizando qualquer Dao
		//sem precisar criar uma classe especifica para cada combinação
