...
public class Client {
	...
	//O padrão Decorator tem como objetivo adicionar novas resposabilidades a um objeto dinamicamente
	//Os Decorators oferecem uma alternativa flexível ao uso de herança para estender uma funcionalidade
